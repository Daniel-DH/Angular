...
export class DataService {
  ...
  registrar(username: string, name: string, email: string, password: string) {
    const usuario = {username, name, email, password};
  ...
  agregarCerebros(flavor: string, description: string, iq: string, picture: string ) {
